...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Załóż konto imprezowicza') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nick" class="col-md-4 col-form-label text-md-end">{{ __('Nazwa użytkownika') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="dob" class="col-md-4 col-form-label text-md-end">{{ __('Data urodzenia') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="loc" class="col-md-4 col-form-label text-md-end">{{ __('Miasto') }}</label>

                            <div class="col-md-6">
                                <input id="loc" type="text" class="form-control @error('loc') is-invalid @enderror" name="loc" value="{{ old('loc') }}" required autocomplete="loc" autofocus>
